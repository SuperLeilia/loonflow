    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intervene_type_id', models.IntegerField(default=0, help_text='见service.constant_service中定义', verbose_name='干预类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant', models.CharField(blank=True, default='', help_text='可以为空(无处理人的情况，如结束状态)、username\\多个username(以,隔开)\\部门id\\角色id\\脚本文件名等', max_length=1000, verbose_name='当前处理人')),
                ...
                ('act_state_id', models.IntegerField(default=1, help_text='当前工单的进行状态,详见service.constant_service中定义', verbose_name='进行状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.ForeignKey(db_constraint=False, on_delete=False, to='ticket.TicketRecord')),
            ],
            options={
                'abstract': False,
            },
